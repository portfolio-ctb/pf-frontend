...
const ButtonMode = ({
  ...
  return (
    <button
      className={`text-neutral-400 hover:text-neutral-600 dark:hover:text-neutral-300 transition-colors duration-300 w-7 rounded-full p-1 ${
        theme === mode &&
        'bg-neutral-300 dark:bg-neutral-500 text-neutral-600 dark:text-neutral-200'
      }`}
